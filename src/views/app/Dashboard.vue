            ...
            <RouterLink :to="{ name: 'app.ticket.detail', params: { code: ticket.code } }" class="block p-6">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-500 mt-1">#{{ ticket.code || 'N/A' }} • Dibuat pada {{
                            ticket.created_at ? DateTime.fromISO(ticket.created_at).toFormat('dd MMMM yyyy, HH:mm') : 'N/A' }}</p>
                        <p class="text-sm text-gray-600 mt-2">{{ ticket.description || 'Tidak ada deskripsi' }}</p>
                        <div class="mt-4 flex items-center space-x-4">
                            ...
                            <div class="flex items-center text-sm text-gray-500">
                                ...
                                <span>Terakhir diupdate {{
                                    ticket.updated_at ? DateTime.fromISO(ticket.updated_at).toFormat('dd MMMM yyyy, HH:mm') : 'N/A' }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="ml-4">
